...
int sz[3005];
int a[3005][3005];
ll sum[3005][3005] , DP[3005] , ret = 0;
...
void zero_one_bag_DP(int l , int r){
    rep(i , l , r){
        rrep(j , K , sz[i]){
            DP[j] = max(DP[j] , DP[j - sz[i]] + sum[i][sz[i]]);
        }
    }
}
